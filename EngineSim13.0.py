...
# Modified color constants - removed pink color
PISTON_COLOR = (255, 255, 255)  # White pistons
CYLINDER_COLOR = (150, 150, 150)  # Changed to gray cylinders
...
class VariableEngineSimulator:
    ...
    def draw_bank(self, crank_x, crank_y, bank_angle, cylinder_indices):
        ...
        for i, cyl_idx in reversed(list(enumerate(cylinder_indices))):
            ...
            # Draw outer cylinder border with gray color
            ...
            # Removed the valve and spring details (yellow and blue dots)
