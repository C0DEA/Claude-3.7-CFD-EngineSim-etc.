...
class Engine:
    def __init__(self):
        ...
        # Modified: Use the same crank pin angle for all cylinders to ensure identical stroke
        self.crank_pin_angles = [0, 0, 0, 0, 0, 0]  # All cylinders have identical stroke
