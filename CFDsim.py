...
class SimplifiedCFDSolver:
    ...
    def __init__(self):
        ...
        self.angle = 0.0      # angle of attack in degrees
    ...
    def calculate_pressure(self):
        ...
        # Create a flow direction vector based on angle of attack
        flow_dir = np.array([np.cos(np.radians(self.angle)), 0, np.sin(np.radians(self.angle))])
    ...
    def generate_streamlines(self, domain_size=10, grid_density=10):
        ...
        # Flow direction based on angle of attack
        flow_dir = np.array([np.cos(np.radians(self.angle)), 0, np.sin(np.radians(self.angle))])
...
class CFDVisualizationApp(QMainWindow):
    ...
    def initUI(self):
        ...
        flow_layout.addRow("Angle of Attack:", self.angle_spin)
    ...
    def display_pressure(self):
        ...
        if not self.model_actor or not self.cfd_solver.mesh:
            return
    ...
    def update_animation(self):
        ...
        if self.streamlines_visible and self.streamlines_actor:
